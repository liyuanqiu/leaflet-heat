import { Layer, Util, Browser, DomUtil, Bounds, point } from 'leaflet';
...
Layer.extend({
  ...
  _initCanvas: function _initCanvas() {
    this._canvas = DomUtil.create('canvas', 'leaflet-heatmap-layer leaflet-layer');
    var canvas = this._canvas;
    var originProp = DomUtil.testProp(['transformOrigin', 'WebkitTransformOrigin', 'msTransformOrigin']);
  ...
  _redraw: function _redraw() {
    ...
    var bounds = new Bounds(point([-r, -r]), size.add([r, r]));
...
export { heatLayer };
//# sourceMappingURL=leaflet-heat-es.esm.js.map
